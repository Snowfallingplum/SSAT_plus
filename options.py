...
class MakeupOptions():
    def __init__(self):
        ...
        # data loader related
        self.parser.add_argument('--dataroot', type=str, default='../../SSAT_code/makeup_datasets/images/', help='path of data')
        ...
        self.parser.add_argument('--semantic_dim', type=int, default=10, help='output_dim')
        ...
        # weight
        self.parser.add_argument('--rec_weight', type=float, default=10, help='rec_weight')
        self.parser.add_argument('--CP_weight', type=float, default=1, help='CP_weight')
        ...
        self.parser.add_argument('--color_weight', type=float, default=100, help='color_weight')
        self.parser.add_argument('--temporal_weight', type=float, default=10, help='temporal_weight')
